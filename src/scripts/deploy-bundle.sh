...
ORB_EVAL_GET_DEPLOYMENT_GROUP_ARGUMENTS="$(eval echo "${ORB_EVAL_GET_DEPLOYMENT_GROUP_ARGUMENTS}")"
ORB_EVAL_BUNDLE_TYPE="$(eval echo "${ORB_EVAL_BUNDLE_TYPE}")"
ORB_EVAL_DEPLOY_BUNDLE_ARGUMENTS="$(eval echo "${ORB_EVAL_DEPLOY_BUNDLE_ARGUMENTS}")"
